#!/usr/bin/env python3
"""
Простой генератор PDF документации для системы ДБО
Использует только стандартные шрифты ReportLab
"""
...
def register_unicode_fonts():
    ...
    try:
        ...
        pdfmetrics.registerFont(UnicodeCIDFont('HeiseiKakuGo-W5'))  # Жирный
        pdfmetrics.registerFont(UnicodeCIDFont('HeiseiMin-W3'))    # Обычный
...
def create_simple_pdf():
    ...
    # Выбираем шрифты в зависимости от доступности Unicode
...
if __name__ == "__main__":
    ...
    try:
        ...
        if register_unicode_fonts():
            ...
            print("⚠️  Поддержка кириллицы: Ограничена")
    except Exception as e:
