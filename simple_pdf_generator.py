#!/usr/bin/env python3
"""
Упрощенный генератор PDF документации для системы ДБО
"""
...
def create_simple_pdf():
    ...
    elements.append(Paragraph("Техническая документация", styles['Heading2']))
    ...
    elements.append(Paragraph("Основные возможности:", styles['Heading3']))
    capabilities = [
    ...
    elements.append(Paragraph("Технологический стек:", styles['Heading3']))
    ...
    elements.append(Paragraph("Компоненты системы:", styles['Heading3']))
    ...
    elements.append(Paragraph("Operator (Операторы ДБО)", styles['Heading3']))
...
class Operator(models.Model):
    ...
    elements.append(Paragraph("Client (Клиенты)", styles['Heading3']))
...
class Client(models.Model):
    ...
    elements.append(Paragraph("Уязвимости для тестирования", styles['Heading3']))
    
    elements.append(Paragraph("1. SQL-инъекция в banking_services", styles['Heading4']))
...
if category_name:
    ...
    elements.append(Paragraph("Требования", styles['Heading3']))
    requirements = [
        "• Python 3.13+",
        "• Django 5.2.7", 
    ...
    elements.append(Paragraph("Установка", styles['Heading3']))
    install_steps = [
    ...
    elements.append(Paragraph("Основные преимущества:", styles['Heading3']))
    advantages = [
