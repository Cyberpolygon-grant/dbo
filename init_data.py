...
def create_demo_data():
    ...
    try:
        ...
        if len(demo_clients) >= 2 and len(all_cards) >= 2:
            ...
            fee_amounts = [
                D('10.00'), D('15.00'), D('25.00'), D('30.00'), D('50.00'), D('75.00'), 
                D('100.00'), D('150.00'), D('200.00'), D('300.00'), D('500.00')
            ]
            fee_descriptions = [
                "Комиссия за перевод",
            ...
            created_count = 0
            transaction_types_created = {'transfer': 0, 'payment': 0, 'deposit': 0, 'withdrawal': 0, 'fee': 0}
