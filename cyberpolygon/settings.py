...
SECRET_KEY = 'django-insecure-y!wcqf#fkobnhm^mib=j2n_#4_!tff9wli_oibro6fh3n85tm^'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS is set below from environment variable
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
                'context_processors': [
                    ...
                    'dbo.context_processors.news_ticker',
                ],
        },
    },
]
...
# Use PostgreSQL if available, otherwise fallback to SQLite for local development
